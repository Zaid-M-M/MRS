          ...
          <div className="container">
            ...
            <div className="solu-clm-3 sticky-solution">
                    ...
                    <div className="solu-content">
                      ...
                      <ul className="white" >
                        <li data-aos="fade-in" data-aos-duration="500" data-aos-once="true" data-aos-delay="600">Warehousing Solutions</li>
                        <li data-aos="fade-in" data-aos-duration="500" data-aos-once="true" data-aos-delay="800">Free Trade Zone, Mundra SEZ</li>
