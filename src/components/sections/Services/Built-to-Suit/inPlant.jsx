...
export default function inPlant () {
    return (
        <>
        <div className="inPlant-sec section-padd-LR overflow">
            <div className="main-container width-1200 black built-to-suit-container1 inPlant-container">     
                <div className='row built-row'>
                    <div className='clm-2 built-cntnt-clm'>   
                        <h2 className='ttl-45px'>In-Plant Warehouse Management</h2>                      
                        <p>At MRS, we are dedicated to elevating the efficiency of your manufacturing operations through our cutting-edge In-Plant Warehousing Services. We specialise in delivering comprehensive in-plant warehousing solutions meticulously designed to cater to the unique needs of your manufacturing processes.</p>
                    </div>
                ...
                <h3 className='we-offer-txt blue'>Our services encompass:</h3>
                ...
                <div>
                    ...
                    <p className='margin-o'>Elevate your manufacturing efficiency with MRS In-Plant Warehousing Services – where precision, innovation, and adaptability converge to enhance your operational excellence.</p>
                </div>
